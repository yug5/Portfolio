...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      id="home"
      className="h-[260vh]  bg-gradient-to-b from-black to-black py-40 overflow-hidden  antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
    >
      <Header />
      <motion.div
        style={{
